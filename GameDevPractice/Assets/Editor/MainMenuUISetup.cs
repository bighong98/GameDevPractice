...
{
    private const string SetupKey = "MainMenuUISetup_Done_v1";
    
    static MainMenuUISetup()
    {
    ...
    private static void SetupMainMenu()
    {
        ...
        if (panel == null)
        {
            Debug.LogWarning("[MainMenuUISetup] MainMenuPanel not found");
            return;
        }
        ...
        Debug.Log("[MainMenuUISetup] Main menu UI setup completed!");
    }
    
    [MenuItem("Tools/Reset MainMenuUI Setup Flag")]
    public static void ResetSetupFlag()
    {
        EditorPrefs.DeleteKey(SetupKey);
        Debug.Log("[MainMenuUISetup] Setup flag reset. Restart Unity to re-run setup.");
    }
}
#endif