    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target {
                ...
                // === DIAMOND GEOMETRY DISTANCE CALCULATION ===
                // Diamond uses Manhattan distance for 45-degree rotated square shape
                float2 center = float2(0.5, 0.5);
                float distance = abs(i.uv.x - center.x) + abs(i.uv.y - center.y);
